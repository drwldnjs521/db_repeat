...
import de.hhu.cs.dbs.propra.infrastructure.repositories.NutzerRepositoryImpl;
import de.hhu.cs.dbs.propra.infrastructure.repositories.PremiumNutzerNutzerRepoImpl;
...
public class AbstractBinder extends org.glassfish.hk2.utilities.binding.AbstractBinder {
    ...
    protected void configure() {
        ...
        bind(NutzerRepositoryImpl.class).to(NutzerRepository.class);
        bind(PremiumNutzerNutzerRepoImpl.class).to(PremiumNutzerRepo.class);
